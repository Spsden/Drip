...
// //
// //     final CurrentTracks = CurrentTracksFromJson(jsonString);
//
// import 'package:meta/meta.dart';
// import 'dart:convert';
//
// List<CurrentTracks> CurrentTracksFromJson(String str) =>
//     List<CurrentTracks>.from(json.decode(str).map((x) => CurrentTracks.fromJson(x)));
//
// String CurrentTracksToJson(List<CurrentTracks> data) =>
...
//   dynamic year;
//
//   factory CurrentTracks.fromJson(Map<String, dynamic> json) => CurrentTracks(
