...
class PlaylistCard extends ConsumerWidget {
  const PlaylistCard({Key? key, required this.playlistDataClass})
      : super(key: key);
          ...
          Navigator.push(
              ...
              mat.MaterialPageRoute(
                  builder: (context) => PlaylistMain(
                      playlistId: playlistDataClass.playlistId.toString())));
        },
        child: Padding(
                ...
                Expanded(
                  child: mat.Card(
                    ...
                    child: FadeInImage(
                        ...
                        // height: 37,
                        fit: BoxFit.cover,
                        image: NetworkImage(playlistDataClass
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: ((context, snapshot) {
        ...
        return Center(child: loadingWidget(context, ref.watch(themeProvider).color),);
      }) ,
    );
